  ...
  const submitQuestions = async () => {
    try {
      ...
      const response = await axios.post(
        "https://quizlytics-server-gold.vercel.app/saveManualQuiz",
        quizSet
      );
      Swal.fire({
        title: "Success!",
  ...
  return (
    <div className="h-screen px-5  lg:mx-20  mx-auto">
      <main className="max-w-6xl mx-auto ">
        <div className="">
          <SectionTitleMinimal
            heading={" Create Custom Questions"}
            subHeading={"Create custom questions for your quiz"}
          ></SectionTitleMinimal>
          ...
          <div className="grid gap-6 md:grid-cols-2 mb-3">
            ...
            <div className="relative">
              <label className="block font-bold text-gray-700">Question</label>
              <Input
                type="text"
                name="question"
          ...
          <div className="relative mb-3">
            <label className="block font-bold text-gray-700">Options</label>
