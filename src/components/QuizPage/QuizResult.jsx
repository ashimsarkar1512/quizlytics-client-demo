...
const QuizResult = ({
  ...
  let postUrl = "";
  if (quizStartKey) {
    postUrl = "https://quizlytics-server-gold.vercel.app/saveHistory";
  } else if (searchCategory) {
    postUrl = "https://quizlytics-server-gold.vercel.app/saveAiQuiz";
  } else {
    postUrl = "https://quizlytics-server-gold.vercel.app/linkQuiz";
  }
