...
export const postNewUser = async (newUser) => {
  try {
    const response = await axios.post(
      "https://quizlytics-server-gold.vercel.app/registered_users",
      newUser
    );
    return response;
  } catch (error) {
...
export const postUserWithProvider = async (newUser) => {
  try {
    const response = await axios.post(
      "https://quizlytics-server-gold.vercel.app/authenticating_with_providers",
      newUser
    );
    return response;
  } catch (error) {
...
export const postUserExamData = async (userExamData) => {
  try {
    const response = await axios.post(
      "https://quizlytics-server-gold.vercel.app/user_exam_data",
      userExamData
    );
    return response;
  } catch (error) {
...
export const postOnlyMark = async (userMark) => {
  try {
    const response = await axios.post(
      "https://quizlytics-server-gold.vercel.app/only_user_mark",
      userMark
    );
    return response;
  } catch (error) {
